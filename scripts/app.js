function init() {
  ...
  function buildBoard() {
    ...
    setInterval(checkForFireDeath,20)
  ...
  function fireTrapActivate() {
    let topFirePosition = 21
    let bottomFirePosition = 361
    cells[topFirePosition].classList.add('fire')
    cells[bottomFirePosition].classList.add('fire')

    const fireTrap = setInterval(() => {
      topFirePosition += 20
      bottomFirePosition -= 20
      cells[topFirePosition].classList.add('fire')
      cells[bottomFirePosition].classList.add('fire')
      if (topFirePosition === 181){
  ...
  function removeFire(){
    let topFire = 21
    let bottomFire = 361
    cells[topFire].classList.remove('fire')
    cells[bottomFire].classList.remove('fire')
