function init() {
  ...
  function spriteAnimate(direction){
    ...
    if (direction === 'left' || direction === 'right'){
      spriteStyleSheet.innerHTML = `.pacman { background-image: url("SEI-Game-Project/assets/sprite${spriteNumber}.png"); background-size: contain; ${scale}}` //changes the stylesheet so the pacman class shows the left/right
    }
    if (direction === 'up') {
      spriteStyleSheet.innerHTML = `.pacman { background-image: url("SEI-Game-Project/assets/spriteUp${spriteNumber}.png"); background-size: contain;}` // up moving sprite images, cycle thorugh spriteUp 1-3 images
    }
    if (direction === 'down') {
      spriteStyleSheet.innerHTML = `.pacman { background-image: url("SEI-Game-Project/assets/spriteDown${spriteNumber}.png"); background-size: contain;}` // down moving sprite images, cycle thorugh spriteDown 1-3 images
    }
